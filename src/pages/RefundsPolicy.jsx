      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-12 text-gray-600 leading-relaxed prose prose-lg max-w-none">
          <section>
            ...
            <p>At SHABIL, we take pride in the quality and craftsmanship of our products. If you are not completely satisfied with your purchase, you may return any item within 14 days of delivery, provided it is in its original condition, unworn, and with all tags attached.</p>
          </section>
          ...
          <section>
            ...
            <p>If you wish to exchange an item for a different size or color, please contact our concierge team at concierge@shabil.com to initiate the process.</p>
          </section>
