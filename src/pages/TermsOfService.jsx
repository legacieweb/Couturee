      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-12 text-gray-600 leading-relaxed prose prose-lg max-w-none">
          ...
          <section>
            ...
            <p>All content on this website, including but not limited to text, images, logos, and designs, is the property of COUTREE 254 and is protected by copyright and other intellectual property laws. You may not reproduce, distribute, or use any content without our prior written consent.</p>
          </section>
