export const categorySizeGuides = {
  "Tops": {
    ...
    chart: [
      ...
      { s: 'Extra Large', c: 'XL', b: '96-100', w: '76-80', h: '40-42' }
    ],
    labels: {
      col1: 'Bust (CM)',
      col2: 'Waist (CM)',
  ...
  "Jackets": {
    anatomy: [
      ...
      { l: 'Sleeve Length', d: 'Measure from the shoulder point to the wrist.', icon: '03' }
    ],
    chart: [
      { s: 'Small', c: 'S', b: '92-96', w: '44-45', h: '62-63' },
      { s: 'Medium', c: 'M', b: '96-100', w: '45-46', h: '63-64' },
      { s: 'Large', c: 'L', b: '100-104', w: '46-47', h: '64-65' },
      { s: 'Extra Large', c: 'XL', b: '104-108', w: '47-48', h: '65-66' }
    ],
    labels: {
      col1: 'Chest (CM)',
      col2: 'Shoulder (CM)',
  ...
  "Dresses": {
    anatomy: [
      ...
      { l: 'The Hips', d: 'Measure around the fullest part of your hips.', icon: '03' }
    ],
    chart: [
      { s: 'Extra Small', c: 'XS', b: '82', w: '64', h: '90' },
      { s: 'Small', c: 'S', b: '86', w: '68', h: '94' },
      { s: 'Medium', c: 'M', b: '90', w: '72', h: '98' },
      { s: 'Large', c: 'L', b: '94', w: '76', h: '102' }
    ],
    labels: {
      col1: 'Bust (CM)',
      col2: 'Waist (CM)',
  ...
  "Bottoms": {
    ...
    chart: [
      ...
      { s: 'Medium', c: 'M', b: '74-78', w: '96-100', h: '80-82' },
      { s: 'Large', c: 'L', b: '78-82', w: '100-104', h: '82-84' }
    ],
    labels: {
      col1: 'Waist (CM)',
      col2: 'Hips (CM)',
  ...
  "Handbags": {
    anatomy: [
      ...
      { l: 'Total Length', d: 'Measure from the waist to the ankle.', icon: '03' }
    ],
    chart: [
      { s: 'Small', c: 'S', b: '68-72', w: '94-98', h: '100-102' },
      { s: 'Medium', c: 'M', b: '72-76', w: '98-102', h: '102-104' },
      { s: 'Large', c: 'L', b: '76-80', w: '102-106', h: '104-106' },
      { s: 'Extra Large', c: 'XL', b: '80-84', w: '106-110', h: '106-108' }
    ],
    labels: {
      col1: 'Waist (CM)',
      col2: 'Hips (CM)',
